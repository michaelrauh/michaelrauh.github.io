...
Statistically, most bugs occur when a function gets data that is unexpected or at the wrong time. This system does not make these bugs impossible to write, but it points out to the user when they are about to do a bad thing, and suggests a good thing instead.
